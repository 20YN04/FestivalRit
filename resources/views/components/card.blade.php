...
<div {{ $attributes->class([
    'relative overflow-hidden rounded-3xl border border-white/7 bg-linear-to-b from-white/4 to-white/1 p-6 shadow-[0_24px_60px_-30px_rgba(0,0,0,0.9)] backdrop-blur-md',
]) }}>
    @if ($eyebrow)
